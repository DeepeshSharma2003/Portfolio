          ...
          <div className={` ${ darkTheme ? "dark-theme-shadow dark-theme-bg" : "light-theme-shadow light-theme-bg"} contact-info rounded-5 d-flex flex-column justify-content-evenly align-items-center `}>
            <div className="email rounded-4 py-3 d-flex align-items-center">
              ...
              <div className="email-info">
                <b>Email</b> <br />
                <a className='link' href="mailto:deepeshsharma1305@gmail.com">deepeshsharma1305@gmail.com</a>
              </div>
            </div>
            <div className="mobile rounded-4 py-3 d-flex align-items-center">
              ...
              <div className="mobile-info">
                <b>Phone</b> <br />
                <a className='link' href="tel:+919560545070">+91 8448554475</a>
              </div>
            </div>
            <div className="mobile rounded-4 py-3 d-flex align-items-center">
              <div className="mobile-icon px-4">
              ...
              <div className="mobile-info">
                <b>LinkedIn</b> <br />
                <Link className='link' to='https://www.linkedin.com/in/deepesh-sharma-8312aa258/' target='blank' >https://www.linkedin.com/in/deepesh-sharma-8312aa258/</Link>
              </div>
            </div>
          </div>
        </div>
